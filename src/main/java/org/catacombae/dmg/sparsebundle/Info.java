...
class Info extends BundleMember {
    ...
    protected void refresh() throws RuntimeIOException {
        ...
        if (cfBundleInfoDictionaryVersionReader == null)
            throw new RuntimeIOException("Could not find '" + cfBundleInfoDictionaryVersionKey + "' key in Info.plist " + "file.");
        ...
        if (!diskImageBundleTypeString.equals("com.apple.diskimage.sparsebundle")) {
            throw new RuntimeIOException("Unexpected value for '" + diskImageBundleTypeKey + "': " + diskImageBundleTypeString);
