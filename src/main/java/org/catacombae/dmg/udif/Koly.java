...
public class Koly {
    ...
    /*
     * struct Koly size: 512 bytes description:
     *
     * BP Size Type Identifier Description
     * -------------------------------------------------------- 0 4 UInt32 fourCC 4
     * 1*28 byte[28] unknown1 32 8 UInt64 plistBegin1 40 8 UInt64 plistEndSometimes
     * 48 8 UInt64 unknown2 56 8 UInt64 unknown3 64 8 UInt64 unknown4 72 8 UInt64
     * unknown5 80 8 UInt64 possibleChecksumType 88 4 UInt32 unknown6 92 4 UInt32
     * possibleUnitSize 96 1*120 byte[120] unknown7 216 8 UInt64 plistBegin2 224 8
     * UInt64 plistSize 232 1*120 byte[120] unknown8 352 4 UInt32 checksumAlgorithm
     * 356 4 UInt32 checksumSize 360 1*152 byte[152] checksumData
     */
    ...
    public int getFourCC() {
        return org.catacombae.util.Util.readIntBE(fourCC);
    }

    public byte[] getUnknown1() {
        return org.catacombae.util.Util.createCopy(unknown1);
    }

    public long getPlistBegin1() {
        return org.catacombae.util.Util.readLongBE(plistBegin1);
    }

    public long getPlistEndSometimes() {
        return org.catacombae.util.Util.readLongBE(plistEndSometimes);
    }

    public long getUnknown2() {
        return org.catacombae.util.Util.readLongBE(unknown2);
    }

    public long getUnknown3() {
        return org.catacombae.util.Util.readLongBE(unknown3);
    }

    public long getUnknown4() {
        return org.catacombae.util.Util.readLongBE(unknown4);
    }

    public long getUnknown5() {
        return org.catacombae.util.Util.readLongBE(unknown5);
    }

    public long getPossibleChecksumType() {
        return org.catacombae.util.Util.readLongBE(possibleChecksumType);
    }

    public int getUnknown6() {
        return org.catacombae.util.Util.readIntBE(unknown6);
    }

    public int getPossibleUnitSize() {
        return org.catacombae.util.Util.readIntBE(possibleUnitSize);
    }

    public byte[] getUnknown7() {
        return org.catacombae.util.Util.createCopy(unknown7);
    }

    public long getPlistBegin2() {
        return org.catacombae.util.Util.readLongBE(plistBegin2);
    }

    public long getPlistSize() {
        return org.catacombae.util.Util.readLongBE(plistSize);
    }

    public byte[] getUnknown8() {
        return org.catacombae.util.Util.createCopy(unknown8);
    }

    public int getChecksumAlgorithm() {
        return org.catacombae.util.Util.readIntBE(checksumAlgorithm);
    }

    public int getChecksumSize() {
        return org.catacombae.util.Util.readIntBE(checksumSize);
    }

    public byte[] getChecksumData() {
        return org.catacombae.util.Util.createCopy(checksumData);
    }
    ...
    public void printFields(PrintStream ps, String prefix) {
        ps.println(prefix + " fourCC: \"" + org.catacombae.util.Util.toASCIIString(getFourCC()) + "\"");
        ps.println(prefix + " unknown1: 0x" + org.catacombae.util.Util.byteArrayToHexString(getUnknown1()));
        ...
        ps.println(prefix + " unknown7: 0x" + org.catacombae.util.Util.byteArrayToHexString(getUnknown7()));
        ps.println(prefix + " plistBegin2: " + getPlistBegin2());
        ps.println(prefix + " plistSize: " + getPlistSize());
        ps.println(prefix + " unknown8: 0x" + org.catacombae.util.Util.byteArrayToHexString(getUnknown8()));
        ...
        ps.println(prefix + " checksumData: 0x" + org.catacombae.util.Util.byteArrayToHexString(checksumData, 0, checksumSize)); // checksumSize is in
                                                                                                                                 // bits
        int i;
        for (i = 0; i + 4 <= (checksumData.length - checksumSize); i += 4)
            ps.println(prefix + " trailing data[" + i + "]: 0x " + org.catacombae.util.Util.byteArrayToHexString(checksumData, checksumSize + i, 4));
        int bytesLeft = i + 4 - (checksumData.length - checksumSize);
        if (bytesLeft > 0 && bytesLeft < 4) {
            System.err.println("bytes left: " + bytesLeft);
            ps.println(prefix + " trailing data[" + i + "]: 0x "
                    + org.catacombae.util.Util.byteArrayToHexString(checksumData, checksumSize + i, (i + 4) - (checksumData.length - checksumSize)));
        }
    }
