...
public class ExperimentalV1Header {
    /*
     * struct ExperimentalV1Header size: 1276 bytes description:
     *
     ...
     * key derivation function 88 4 uint32_t laban Unknown variable with observed
     * value 16/0x10. 92 4 uint32_t edward Unknown variable with observed value
     * 5/0x5. 96 4 uint32_t palle Unknown variable with observed value 0x80000001.
     * 100 4 uint32_t lisa Unknown variable with observed value 128/0x80. 104 1*32
     * uint8_t[32] unwrapIv Initialization Vector for encryption-key unwrapping. 136
     * 4 uint32_t lenWrappedAesKey Length of wrappedAesKey in bytes (max 256). 140
     * 1*256 uint8_t[256] wrappedAesKey The AES key (wrapped). 396 4 uint32_t
    ...
    public int getLaban() {
        return org.catacombae.util.Util.readIntBE(laban);
    }

    /** Unknown variable with observed value 5/0x5. */
    public int getEdward() {
        return org.catacombae.util.Util.readIntBE(edward);
    }

    /** Unknown variable with observed value 0x80000001. */
    public int getPalle() {
        return org.catacombae.util.Util.readIntBE(palle);
    }

    /** Unknown variable with observed value 128/0x80. */
    public int getLisa() {
        return org.catacombae.util.Util.readIntBE(lisa);
    }
