...
//     }
    ...
    /**
     * Looks up the byte array with identifer <code>fieldName</code> in the current
     * class and returns it (an actual reference, no copy). If no identifier can be
     * found, or the identifier is not of type <code>byte[]</code>, an
