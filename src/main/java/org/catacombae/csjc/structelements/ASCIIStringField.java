...
public class ASCIIStringField extends StringRepresentableField {
    ...
    public ASCIIStringField(byte[] fieldData) {
        ...
        /*
         * if(validateMsg != null) { throw new
         * IllegalArgumentException("Invalid value passed to constructor! Message: " +
         * validateMsg); }
         */
    }
    ...
    public String validateStringValue(String s) {
        ...
        for (int i = 0; i < asciiArray.length; ++i) {
            ...
            // Knowing that UTF-16 code units are ASCII compatible, we will do a simple
            // check.
