...
public class DictionaryBuilder {
    ...
    public void addIntArray(String key, byte[] data, IntegerFieldBits bits, Signedness signedness, Endianness endianness, String description,
    ...
    public void addIntArray(String key, byte[] data, int offset, int length, IntegerFieldBits bits, Signedness signedness, Endianness endianness,
            String description, IntegerFieldRepresentation rep) {
        ...
        // System.err.println("DictionaryBuilder.addIntArray(): bits.getBytes() = " +
        // bits.getBytes());
        ...
        // System.err.println("DictionaryBuilder.addIntArray(): i = " + i);
        // System.err.println("DictionaryBuilder.addIntArray(): length/bits.getBytes() =
        // " + (length / bits.getBytes()));
    ...
    public void add(String key, StructElement mapping, String description) {
        // System.err.println(this + ": add(" + key + ", " + mapping + ", " +
        // description + ");");
    ...
    public void addInt(String key, byte[] data, int offset, int length, Signedness signedness, Endianness endianness, String description, String unit,
            IntegerFieldRepresentation rep) {
        switch (length) {
        case 1:
            add(key, new IntegerField(data, offset, BITS_8, signedness, endianness, rep, unit), description);
            break;
        case 2:
            add(key, new IntegerField(data, offset, BITS_16, signedness, endianness, rep, unit), description);
            break;
        case 4:
            add(key, new IntegerField(data, offset, BITS_32, signedness, endianness, rep, unit), description);
            break;
        case 8:
            add(key, new IntegerField(data, offset, BITS_64, signedness, endianness, rep, unit), description);
            break;
        default:
    ...
    public void addInt(String key, Field field, Object obj, Signedness signedness, Endianness endianness, String description, String unit,
            IntegerFieldRepresentation rep) {
        int length = getSize(field);
        switch (length) {
        case 1:
            add(key, new IntegerField(obj, field, 0, BITS_8, signedness, endianness, rep, unit), description);
            break;
        case 2:
            add(key, new IntegerField(obj, field, 0, BITS_16, signedness, endianness, rep, unit), description);
            break;
        case 4:
            add(key, new IntegerField(obj, field, 0, BITS_32, signedness, endianness, rep, unit), description);
            break;
        case 8:
            add(key, new IntegerField(obj, field, 0, BITS_64, signedness, endianness, rep, unit), description);
            break;
        default:
            throw new IllegalArgumentException("You supplied a " + (length * 8) + "-bit value. Only 64, 32, 16 and " + "8-bit values are supported.");
        }
    ...
    /*
     * public void addSInt8(String key, byte[] data) { addSInt8(key, data, 0); }
     * public void addSInt8(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_8, SIGNED, BIG_ENDIAN)); } public void
     * addUInt8(String key, byte[] data) { addUInt8(key, data, 0); } public void
     * addUInt8(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_8, UNSIGNED, BIG_ENDIAN)); } public void
     * addSInt16LE(String key, byte[] data) { addUInt16LE(key, data, 0); } public
     * void addSInt16LE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_16, SIGNED, LITTLE_ENDIAN)); } public void
     * addSInt16BE(String key, byte[] data) { addSInt16BE(key, data, 0); } public
     * void addSInt16BE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_16, SIGNED, BIG_ENDIAN)); } public void
     * addUInt16LE(String key, byte[] data) { addUInt16LE(key, data, 0); } public
     * void addUInt16LE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_16, UNSIGNED, LITTLE_ENDIAN)); } public void
     * addUInt16BE(String key, byte[] data) { addUInt16BE(key, data, 0); } public
     * void addUInt16BE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_16, UNSIGNED, BIG_ENDIAN)); } public void
     * addSInt32LE(String key, byte[] data) { addUInt32LE(key, data, 0); } public
     * void addSInt32LE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_32, SIGNED, LITTLE_ENDIAN)); } public void
     * addSInt32BE(String key, byte[] data) { addSInt32BE(key, data, 0); } public
     * void addSInt32BE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_32, SIGNED, BIG_ENDIAN)); } public void
     * addUInt32LE(String key, byte[] data) { addUInt32LE(key, data, 0); } public
     * void addUInt32LE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_32, UNSIGNED, LITTLE_ENDIAN)); } public void
     * addUInt32BE(String key, byte[] data) { addUInt32BE(key, data, 0); } public
     * void addUInt32BE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_32, UNSIGNED, BIG_ENDIAN)); } public void
     * addSInt64LE(String key, byte[] data) { addUInt64LE(key, data, 0); } public
     * void addSInt64LE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_64, SIGNED, LITTLE_ENDIAN)); } public void
     * addSInt64BE(String key, byte[] data) { addSInt64BE(key, data, 0); } public
     * void addSInt64BE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_64, SIGNED, BIG_ENDIAN)); } public void
     * addUInt64LE(String key, byte[] data) { addUInt64LE(key, data, 0); } public
     * void addUInt64LE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_64, UNSIGNED, LITTLE_ENDIAN)); } public void
     * addUInt64BE(String key, byte[] data) { addUInt64BE(key, data, 0); } public
     * void addUInt64BE(String key, byte[] data, int offset) { add(key, new
     * IntegerField(data, BITS_64, UNSIGNED, BIG_ENDIAN)); }
     */
    ...
    public int getSize(Field field) {
        ...
        if (fieldType.equals(byte.class))
            size = 1;
        else if (fieldType.equals(short.class) || fieldType.equals(char.class))
            size = 2;
