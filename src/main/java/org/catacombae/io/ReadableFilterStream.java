 ...
 * one to one to the underlying ReadableRandomAccessStream. There's no practical
 * use for this class other than to facilitate filtering subclasses which can
 * override all operations, or just a few of them.
 *
