...
public interface SynchronizedReadableRandomAccess extends SynchronizedReadable, RandomAccess {
    /**
     * All open substreams of this stream must be added as references so that the
     * synchronized stream knows when it is safe to <code>close();</code> itself.
     *
    ...
    /**
     * When a substream closes, it must remove itself from the reference list of the
     * parent stream.
     *
     * @param referrer the object referring to this stream.
     */
