 ...
 * This is a subclass of RuntimeExceptions that are meant to be thrown when it
 * is caused by I/O problems.
 *
...
public class RuntimeIOException extends RuntimeException {
    ...
    /**
     * Returns the IOException that caused this RuntimeIOException to be thrown, or
     * <code>null</code> if the RuntimeIOException was thrown independently.
     *
     * @return the IOException that caused this RuntimeIOException to be thrown, or
     *         <code>null</code> if the RuntimeIOException was thrown independently.
     */
