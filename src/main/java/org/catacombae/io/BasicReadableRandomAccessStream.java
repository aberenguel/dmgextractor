...
/**
 * Basic implementation of many features of ReadableRandomAccessStream, to allow
 * the subclasser to only implement the essential methods needed to support a
