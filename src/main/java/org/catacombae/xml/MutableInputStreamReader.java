...
public class MutableInputStreamReader extends Reader {
    ...
    public void close() throws IOException {
        try {
            if (DEBUG)
                os.println(PREFIX + "isReader.close()");
            isReader.close();
    ...
    public void mark(int readAheadLimit) throws IOException {
        try {
            if (DEBUG)
                os.println(PREFIX + "isReader.mark(" + readAheadLimit + ")");
    ...
    public boolean markSupported() {
        try {
            ...
            if (DEBUG)
                os.println(PREFIX + "isReader.markSupported() == " + result);
            return result;
        } catch (RuntimeException e) {
            if (DEBUG)
                e.printStackTrace();
    ...
    public int read() throws IOException {
        try {
            ...
            if (DEBUG)
                os.println(PREFIX + "isReader.read() == " + result);
            return result;
        } catch (IOException ioe) {
            if (DEBUG)
                ioe.printStackTrace();
    ...
    public int read(char[] cbuf) throws IOException {
        try {
            ...
            if (DEBUG)
                os.println(PREFIX + "isReader.read(" + cbuf.length + " bytes...) == " + result);
            return result;
        } catch (IOException ioe) {
            if (DEBUG)
                ioe.printStackTrace();
    ...
    public int read(char[] cbuf, int off, int len) throws IOException {
        try {
            ...
            if (DEBUG)
                os.println(PREFIX + "isReader.read(" + cbuf.length + " bytes..., " + off + ", " + len + ") == " + result);
            return result;
        } catch (IOException ioe) {
            if (DEBUG)
                ioe.printStackTrace();
    ...
    public int read(CharBuffer target) throws IOException {
        try {
            ...
            if (DEBUG)
                os.println(PREFIX + "isReader.read(CharBuffer with length " + target.length() + ") == " + result);
            return result;
        } catch (IOException ioe) {
            if (DEBUG)
                ioe.printStackTrace();
    ...
    public boolean ready() throws IOException {
        try {
            ...
            if (DEBUG)
                os.println(PREFIX + "isReader.ready() == " + result);
            return result;
        } catch (IOException ioe) {
            if (DEBUG)
                ioe.printStackTrace();
    ...
    public void reset() throws IOException {
        try {
            if (DEBUG)
                os.println(PREFIX + "isReader.reset()");
            isReader.reset();
        } catch (IOException ioe) {
            if (DEBUG)
                ioe.printStackTrace();
    ...
    public long skip(long n) throws IOException {
        try {
            ...
            if (DEBUG)
                os.println(PREFIX + "isReader.skip(" + n + ") == " + result);
            return result;
        } catch (IOException ioe) {
            if (DEBUG)
                ioe.printStackTrace();
    ...
    public void changeEncoding(String charset) throws UnsupportedEncodingException {
        try {
            if (DEBUG)
                os.println(PREFIX + "changeEncoding(\"" + charset + "\")");
