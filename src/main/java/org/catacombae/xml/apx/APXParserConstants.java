...
public interface APXParserConstants {
    ...
    String[] tokenImage = { "<EOF>", "<SINGLE_S>", "<CHAR>", "<NAME>", "<NAMESTART>", "<NAMECHAR>", "<LETTER>", "<BASECHAR>", "<IDEOGRAPHIC>",
            "<COMBININGCHAR>", "<DIGIT>", "<EXTENDER>", "<REFERENCE>", "<ENTITYREF>", "<CHARREF>", "<token of kind 15>", "\"<\"", "\"</\"", "\"<?\"",
            "\"<?xml\"", "\"<!DOCTYPE\"", "\"<!--\"", "\"<![CDATA[\"", "<CHARDATA>", "<DEFAULT_REFERENCE>", "\"?>\"", "\"=\"", "\"\\\"\"", "\"\\\'\"",
            "\"version\"", "\"encoding\"", "\"standalone\"", "<token of kind 32>", "<XD_DQUOTE_STRING>", "\"\\\"\"", "<XD_SQUOTE_STRING>", "\"\\\'\"",
            "\"=\\\"\"", "\"\\\"\"", "\"=\\\'\"", "\"\\\'\"", "\"1.0\"", "\"=\\\"\"", "\"\\\"\"", "\"=\\\'\"", "\"\\\'\"", "\"yes\"", "\"no\"",
            "<WDD_NAME>", "\">\"", "<EXTERNALID>", "<SYSTEMLITERAL>", "<PUBIDLITERAL>", "<PUBIDCHAR>", "\"[\"", "<token of kind 55>", "\"]\"",
            "<WHATEVER>", "\"-->\"", "\"--\"", "<COMMENT_CHAR>", "\"?>\"", "<ILLEGALTARGET>", "<PITARGET>", "<WITHINPI_S>", "<PC_CHAR>", "\"=\"",
            "<WT_NAME>", "\"\\\"\"", "\"\\\'\"", "\"/>\"", "\">\"", "<token of kind 72>", "\"\\\"\"", "\"\\\'\"", "<ATTR_DQUOTE_STRING>",
            "<ATTR_SQUOTE_STRING>", "<ATTR_REFERENCE>", "\"]]>\"", "<WCD_CHAR>", };
