...
/**
 * Early version of the APX Parser for XML. Currently does not parse DTDs and so
 * doesn't check for any validity constraints. It just breaks up the syntactic
 * structure of an XML file and reports it to an
 * org.catacombae.xml.XMLContentHandler. This is sufficient for my needs so it
...
public class APXParser implements APXParserConstants {
    ...
    /**
     * Test main method. The first and only argument denotes a file containing an
     * XML document.
     */
    public static void main(String[] args) throws Exception {
        ...
        // Then we create a new stream, and parse the entire document using the
    ...
    /**
     * This is the way to create an APXParser. Don't use the constructor even if it
     * would be possible.
     * 
     * @param misr the reader supplying the input data for the parser. Can not be
     *             null.
     * @param xch  the content handler that takes care of the contents of the parsed
     *             XML document. Can not be null. Use NullXMLContentHandler if you
     *             are not intrested in the contents of the document.
    ...
    /*
     * For convenience, this method returns the encoding. We need to determine that
...
// returns the content of the processor instruction, minus the trailing "?>"
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[] { 0x240000, 0x80000, 0x240000, 0x240000, 0x100000, 0x40000000, 0x80000000, 0x0, 0x18000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x240000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800000, 0x1650000, 0x1650000, 0x800000, 0x800000, 0x0, 0x0, };
    }

    private static void jj_la1_1() {
        jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa0, 0x0, 0xc000, 0xc000, 0x1400, 0x40000, 0x400000, 0x2000000, 0x0, 0x10000000,
                0x20000000, 0x20000000, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
    }

    private static void jj_la1_2() {
        jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x2, 0x2, 0x8, 0xc0, 0x2800,
                0x2800, 0x3000, 0x3000, 0x30, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc000, 0xc000, };
    }
