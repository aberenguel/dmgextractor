...
public class IOUtil {
    /**
     * Reads the supplied ReadableRandomAccessStream from its current position until
     * the end of the stream.
     *
     * @param s
     * @return the contents of the remainder of the stream.
     * @throws org.catacombae.io.RuntimeIOException if an I/O error occurred when
     *                                              reading the stream.
     */
