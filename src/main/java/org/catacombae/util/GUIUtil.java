...
/**
 * Utility functions that the GUI designer can use to ease his/her existential
 * suffering.
 *
...
public class GUIUtil {
    /**
     * Displays an exception dialog with a stack trace. Convenience method that
     * omits a user defined message and sets the default window title to "Exception"
     * and the message type to JOptionPane.ERROR_MESSAGE. Maximum lines shown in the
     * stack trace is set to 10.
     *
     ...
     * Displays an exception dialog with a stack trace. Convenience method that
     * omits a user defined message and sets the default window title to "Exception"
     * and the message type to JOptionPane.ERROR_MESSAGE.
     *
     * @see #displayExceptionDialog(Throwable, int, Component, String, String, int)
     * @param t                  the exception thrown.
     * @param maxStackTraceLines the maximum number of lines of the stack trace to
     *                           display.
     * @param c                  the dialog's parent component.
     */
    ...
    /**
     * Displays an exception dialog with a stack trace. Convenience method that sets
     * the default window title to "Exception" and the message type to
     ...
     */
    public static void displayExceptionDialog(final Throwable t, final int maxStackTraceLines, final Component c, final String message,
