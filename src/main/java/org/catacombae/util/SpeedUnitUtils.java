...
public class SpeedUnitUtils {
    ...
    /*
     * public static void main(String[] args) { PrintStream ps = System.err;
     * ps.println("Testing roundDoubleToDecimals:"); ps.println("  Pi: " + Math.PI);
     ...
     * 
     * ps.println("Testing different DecimalFormat variants:"); DecimalFormat[] fmts
     * = new DecimalFormat[] { new DecimalFormat("0"), new DecimalFormat("0.0"), new
     * DecimalFormat("0.00"), new DecimalFormat("0.000"), new
     * DecimalFormat("0.0000"), new DecimalFormat("0.00000"), };
     * 
     * for(int i = 0; i < fmts.length; ++i) { DecimalFormat fmt = fmts[i];
     * ps.println("  Entry " + i + ":"); ps.println("    getMaximumIntegerDigits()="
     * + fmt.getMaximumIntegerDigits()); ps.println("    getMinimumIntegerDigits()="
     * + fmt.getMinimumIntegerDigits());
     * ps.println("    getMaximumFractionDigits()=" +
     * fmt.getMaximumFractionDigits()); ps.println("    getMinimumFractionDigits()="
     * + fmt.getMinimumFractionDigits()); ps.println("    format(Pi)=" +
     * fmt.format(Math.PI)); ps.println("    format(rounded Pi)=" +
     * fmt.format(roundDoubleToDecimals(Math.PI, fmt.getMaximumFractionDigits())));
     * } }
     */
}
