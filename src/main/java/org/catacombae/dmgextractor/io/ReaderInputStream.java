...
public class ReaderInputStream extends InputStream {
    ...
    public ReaderInputStream(Reader r, Charset c) {
        ...
        // System.err.println("Creating a ReaderInputStream. encoder.maxBytesPerChar()
    ...
    /*
     * Säg då att vi skippar 204 bytes. Vad händer? När vi går in i read(3) är
     * remainingChardata = 0, och off = 0, len = 204. b.length = 4096. Alltså kommer
     * ingen av de 4 första if-satserna vara giltiga... I vilken situation kan vi ha
     * läst in mindre data i b än returvärdet?
     */
    @Override
...
// 	    }
        ...
        if (off < endPos && bytesRead == 0) { // We have a break due to end of stream
            ...
            // System.err.println("(2)returning with " + bytesRead + " from
    ...
    public long skip(long n) throws IOException {
        ...
        while (bytesSkipped < n) {
            ...
            if (res > 0) {
                ...
                // System.out.println(" This is the data skipped: " +
                // Util.byteArrayToHexString(skipBuffer, 0, res));
                bytesSkipped += res;
            } else {
